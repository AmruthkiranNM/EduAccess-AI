                    ...
                    lessonJson.visualizations.forEach((vis, idx) => {
                        mapHtml += `
                            <div class="gallery-card viz-card">
                                ...
                                <div class="gallery-img-container" id="viz-container-${idx}" style="position: relative;">
                                    <div class="skeleton-loader" style="width: 100%; height: 100%; position: absolute; top: 0; left: 0; background: linear-gradient(90deg, #f0f0f0 25%, #e0e0e0 50%, #f0f0f0 75%); background-size: 200% 100%; animation: skeleton-loading 1.5s infinite; border-radius: 8px; z-index: 1;"></div>
                                    <img id="viz-img-${idx}" src="${vis.url}" alt="${vis.title}" loading="lazy" style="opacity: 0; transition: opacity 0.3s ease; position: relative; z-index: 2;" onload="this.style.opacity=1; this.previousElementSibling.style.display='none';" onerror="this.onerror=null; this.src='data:image/svg+xml;base64,'; this.style.opacity=1; this.previousElementSibling.style.display='none';">
                                </div>
